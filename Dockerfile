...
ARG ARG_TEAMCITY_VERSION=2017.2.1
ARG ARG_TEAMCITY_WEBAPP_PATH=ROOT

ENV TEAMCITY_VERSION $ARG_TEAMCITY_VERSION
ENV TEAMCITY_WEBAPP_PATH $ARG_TEAMCITY_WEBAPP_PATH
